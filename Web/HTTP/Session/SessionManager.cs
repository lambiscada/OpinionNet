...
using Es.Udc.DotNet.PracticaIS.Web.HTTP.View.ApplicationObjects;
using Es.Udc.DotNet.PracticaIS.Web.HTTP.Util;
...
namespace Es.Udc.DotNet.PracticaIS.Web.HTTP.Session
{
